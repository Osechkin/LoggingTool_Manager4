...
#ifndef DEBUG_MODE
#define MSG_HEADER_DELAY	(100)	// время ожидания конца заголовка сообщений (ms)
#define MSG_REQ_DELAY		(32000)	// Время ожидания отклика на отправленное сообщение (ms)
#define MSG_LIFETIME		(60000)	// "Время жизни" сообщения. Необходимо для удаления сообщений, которые так и не были отправлены	

#define SDSP_REQ_DELAY		(10000)	// время ожидания отклика на сообщение, отправленное в SDSP в режиме диагностики
#else
#define MSG_HEADER_DELAY	(300)	// время ожидания конца заголовка сообщений (ms)
#define MSG_REQ_DELAY		(32000)	// Время ожидания отклика на отправленное сообщение (ms)
#define MSG_LIFETIME		(60000)	// "Время жизни" сообщения. Необходимо для удаления сообщений, которые так и не были отправлены	
